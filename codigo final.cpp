...
public:
    ...
    void crearDios() {
        ...
        diosCreado = true;
        cout << "Entidad suprema 'Dios' creada como raíz del arbol genealogico." << endl;
    }
    ...
    void mostrarInorden() {
        cout << "\n=== ÁRBOL GENEALOGICO (INORDEN) ===" << endl;
        inordenRecursivo(raiz);
    }
    
    void mostrarPreorden() {
        cout << "\n=== ÁRBOL GENEALOGICO (PREORDEN) ===" << endl;
        preordenRecursivo(raiz);
    }
    
    void mostrarPostorden() {
        cout << "\n=== ÁRBOL GENEALOGICO (POSTORDEN) ===" << endl;
    ...
    // Mostrar árbol genealógico por generaciones
...
int main() {
    ...
    cout << "3. Finalmente podrá agregar los demás descendientes" << endl;
    ...
    do {
        ...
        switch (opcion) {
            ...
            case 2: {
                ...
                if (id <= 4) {
                    cout << "Error: Los ID estan reservados para la entidad suprema y tatarabuelos." << endl;
                    break;
                }
